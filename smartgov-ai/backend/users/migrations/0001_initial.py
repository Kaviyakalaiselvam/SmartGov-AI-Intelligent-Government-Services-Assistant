    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('masked_aadhar', models.CharField(max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_communication', models.CharField(choices=[('email', 'Email'), ('sms', 'SMS'), ('both', 'Both')], default='email', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
